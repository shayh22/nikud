...
def render_report(results: list[Result], *, title: str, manifest: dict,
    ...
    lines += [
        ...
        "* `lexicon` ו-`lexicon+quotes` רצים בלי מודל כלל. מילה שאין עליה "
        ...
        "### מה לא נמדד כאן",
        "",
        "Nakdimon אינו בטבלה. המשקולות שלו אינן ב-Hugging Face אלא ברפוזיטורי "
        "GitHub, ולסביבה שבה נבנה המנוע אין גישה אליו. כדי להוסיף אותו יש "
        "להוריד את המשקולות, לעטוף אותם ב-backend עם `vocalize(text) -> str`, "
        "ולהריץ `evaluate.py` עם אותו סט הערכה בדיוק.",
        "",
        "---",
        "",
